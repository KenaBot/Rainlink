...
import type { ServerUpdate, StateUpdatePartial } from "..";
...
export abstract class AbstractLibrary {
	...
	/** @ignore */
	public set(manager: Rainlink): this {
	...
	protected raw(packet: any): void {
		...
		if (packet.t === "VOICE_SERVER_UPDATE") {
			voice.setServerUpdate(packet.d as ServerUpdate);
			return;
		}
		...
		voice.setStateUpdate(packet.d as StateUpdatePartial);
	}
}
