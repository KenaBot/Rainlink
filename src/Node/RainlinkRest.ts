...
import type { NodeInfo } from "../Interface/Node";
import type {
	LavalinkPlayer,
	LavalinkResponse,
	LavalinkStats,
...
import type { RainlinkNode } from "./RainlinkNode";
...
export class RainlinkRest {
	...
	public async getStatus(): Promise<LavalinkStats | undefined> {
		...
		return this.nodeManager.driver.requester<LavalinkStats>(options);
	}
	...
	public async decodeTrack(base64track: string): Promise<RawTrack | undefined> {
		...
		return this.nodeManager.driver.requester<RawTrack>(options);
	}
	...
	public async getRoutePlannerStatus(): Promise<RoutePlanner | undefined> {
		...
		return this.nodeManager.driver.requester<RoutePlanner>(options);
	}
