...
import type { ServerUpdate, StateUpdatePartial } from "../Interface/Connection";
...
export class RainlinkVoice extends EventEmitter {
	...
	public async connect(): Promise<RainlinkVoice> {
		...
		if (this.state === VoiceConnectState.CONNECTING || this.state === VoiceConnectState.CONNECTED) return this;
