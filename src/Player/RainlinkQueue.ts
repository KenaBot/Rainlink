...
export class RainlinkQueue extends Array<RainlinkTrack> {
	 ...
	 */
	public add(track: RainlinkTrack | RainlinkTrack[]): this {
		...
		this.manager.emit(RainlinkEvents.QueueAdd, this.player, this, Array.isArray(track) ? [...track] : [track]);
		return this;
	}
	 ...
	 * @returns RainlinkQueue
	 */
	public remove(position: number): this {
