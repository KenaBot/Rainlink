...
import { type RainlinkSearchResult, RainlinkSearchResultType } from "../Interface/Manager";
import type { RawTrack } from "../Interface/Rest";
import type { ResolveOptions } from "../Interface/Track";
...
export class RainlinkTrack {
	...
	protected async resolverEngine(player: RainlinkPlayer): Promise<RainlinkSearchResult> {
		const { defaultSearchEngine } = player.manager.rainlinkOptions.options!;
